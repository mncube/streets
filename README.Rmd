...
out-degree-3 nodes.  In the example below, two branch paths on a grid
with destination (4,4) both pass through the branch location and exit with steps
that do not produce the minimum Manhattan Distance to the destination.
